...
| 파일 | 역할 | 내용 |
|------|------|------|
| `NB/2025_90_NARITEST.txt` | 통보문 **백업**(과거 누적) | 트랙 1~10번 시점 |
| `source_GEO_Edit_2025(0927)/typhoon.in` | **최신 통보** | 헤더 + 트랙 11번 시점 |
...
| 시각(UTC) | 위치 | 중심기압 | 자동산정 풍속 | 단계 |
|-----------|------|---------|------|------|
| 09-01 00Z | 28.0°N 125.0°E | 962 hPa | 67 kt | 제주 남서 먼바다 |
| 09-02 00Z | 33.0°N 127.4°E | **945 hPa** | 78 kt | 최성기, 제주 동쪽 통과 |
| 09-02 18Z | 35.7°N 129.2°E | 968 hPa | 63 kt | **경남 상륙** |
| 09-03 00Z | 36.6°N 129.8°E | 978 hPa | 55 kt | 내륙·동해 진입, 약화 |
| 09-03 12Z | 38.6°N 131.2°E | 992 hPa | 41 kt | 동해상 소멸기 |

> 전처리기 실행 검증 완료: 백업+최신 병합 → `Model/fort.22` 11시점 정상 생성,
> `Model/fort.8` 모의기간 **5.5일**(트랙 2.5 + 콜드스타트 3) 확인.
