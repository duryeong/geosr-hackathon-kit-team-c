...
| 6 | P5 — CFL 안정성 | fort.14 헤더 읽기, DT×파속/격자간격 추정 | ★★★ | Phase 3 |
| 7 | P6 — Hotstart 타임스탬프 | fort.67/68 바이너리 타임스탬프 읽기 | ★★★ | Phase 3 |
...
| 6 | P5 CFL 안정성 | `check_p5()` | 미구현 |
| 7 | P6 Hotstart 타임스탬프 | `check_p6()` | 미구현 |
